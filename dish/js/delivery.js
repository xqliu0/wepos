...
function getStoreGoodsClassInfo() {
	...
	$('#selected-table-id').val('10000');//外卖订单
...
function set_delivery_info(){
    ...
    if(!myreg.test($("#delivery-address-phone").val())) 
    { 
        $("#delivery-address-phone").focus();
        $("#phone_error").removeClass('ng-hide');
        return false; 
    }else{
        $("#phone_error").addClass('ng-hide');
    }
    if (user_place=="") {
        $("#delivery-address-place").focus();
        $("#address_error").removeClass('ng-hide');
        return false; 
    }else{
        $("#address_error").addClass('ng-hide');
    }
    if (user_time=="") {
        $("#deliveryDateTime").focus();
        $("#time_error").removeClass('ng-hide');
        return false; 
    }else{
        $("#time_error").addClass('ng-hide');
    }
